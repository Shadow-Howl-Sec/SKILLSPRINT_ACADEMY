...
LABS = [
    ...
    ("OverTheWire: Bandit Level 5", "Bash & Scripting Fundamentals", "overthewire",
     ...
     "T1059"),
    ("pwn.college: Linux Luminarium", "Linux Filesystem & Permissions", "pwncollege",
     "https://pwn.college/linux-luminarium/", "self_report", 1, 180, 50,
     "T1059"),
    ("pwn.college: Computing 101", "Bash & Scripting Fundamentals", "pwncollege",
     "https://pwn.college/computing-101/", "self_report", 1, 240, 60,
     "T1059"),
    ("pwn.college: Intro to Cybersecurity", "Networking Basics", "pwncollege",
     "https://pwn.college/intro-to-cybersecurity/", "self_report", 1, 240, 60,
     "T1595"),
